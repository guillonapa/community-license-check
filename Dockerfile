# From https://github.com/docker-library/ruby/blob/master/2.6/alpine3.10/Dockerfile
...
RUN cd /home; \
    git clone https://github.com/TIBCOguillonapa/community-license-check.git; \
    git clone https://github.com/TIBCOSoftware/tibco-streaming-community.git; \
...
RUN echo "cd /home/community-license-check;" > /home/init.sh; \
	echo "git pull;" >> /home/init.sh; \
	echo "cd ../tibco-streaming-community;" >> /home/init.sh; \
	echo "git pull;" >> /home/init.sh; \
